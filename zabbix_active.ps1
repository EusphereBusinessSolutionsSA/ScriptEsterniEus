...
Start-Process -FilePath msiexec.exe -ArgumentList '/l*v','C:\package.log','/i','installer.msi','/qn','SERVER=EUSZABX01,EUSPROXY01,195.65.61.109,195.65.61.168','SERVERACTIVE=EUSZABX01,EUSPROXY01,195.65.61.109:10051,195.65.61.168:10051','HOSTNAMEITEM=system.hostname' -Wait
