...
Start-Process msiexec.exe -ArgumentList "/l*v C:\package.log /i installer.msi /qn SERVER=195.65.61.109,195.65.61.168 SERVERACTIVE=195.65.61.109,195.65.61.168" -Wait
